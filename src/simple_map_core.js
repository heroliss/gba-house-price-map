...
<style>
  ...
  * { box-sizing:border-box; }
  ...
  @media (max-width:760px){ .app{padding:6px;gap:8px;max-width:100vw;overflow:hidden}.mapShell{min-height:82svh;border-radius:10px}header{left:8px;top:8px;max-width:calc(100% - 146px);padding:7px 9px;border:1px solid rgba(219,230,227,.9);border-radius:10px;background:rgba(255,255,255,.72);backdrop-filter:blur(8px)}h1{font-size:17px;line-height:1.1}header p{display:none}.presetBar{left:8px;right:8px;top:51px;max-width:none;overflow-x:auto;flex-wrap:nowrap;padding-bottom:2px}.presetBar button{height:30px;white-space:nowrap;font-size:12px;padding:0 9px}.toolbar{left:auto;right:8px;top:8px;width:121px;display:grid;grid-template-columns:repeat(2,58px);gap:5px}.toolbar button,.toolbar .mapNav{width:58px;height:32px;padding:7px 0;font-size:12px;text-align:center;justify-content:center}.toolbar #toggleTiles{width:121px;grid-column:1/3}.mapControl{left:8px;right:8px;top:auto;width:auto;padding:6px 8px;font-size:11px}.labelControl{bottom:80px}.overlayControl{bottom:126px}svg{height:82svh}.cityLabel{font-size:calc(17px * var(--label-scale));stroke-width:4.8px}.detailLabel{font-size:calc(11px * var(--label-scale));stroke-width:2.9px}.legend{left:8px;right:8px;bottom:8px;padding:8px;border-radius:10px}.swatch{width:auto;flex:1;min-width:0;height:12px}.legendLabels{grid-template-columns:repeat(${colors.length},1fr);gap:4px;font-size:8.4px}.side{padding:14px;border-radius:10px}.sortBar{grid-template-columns:repeat(2,1fr)} }
...
<main class="app">
  <section class="mapShell">
    ...
    <div class="labelControl mapControl"><label for="labelScale">地图文字</label><input id="labelScale" type="range" min="50" max="200" value="100"><span id="labelScaleValue">100%</span></div>
    <div class="overlayControl mapControl"><label for="overlayOpacity">房价图层</label><input id="overlayOpacity" type="range" min="0" max="100" value="${config.overlayOpacity ?? 60}"><span id="overlayOpacityValue">${config.overlayOpacity ?? 60}%</span></div>
